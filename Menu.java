...
public class Menu extends JFrame {
	...
	public Menu() {
		...
		closeButton.addActionListener(e -> {
			int choice = JOptionPane.showConfirmDialog(this, "Bạn có chắc muốn thoát không?", "Xác nhận thoát",
	...
	private void openSortingAlgorithms() {
		...
		String choice = (String) JOptionPane.showInputDialog(this, "Chọn thuật toán sắp xếp:", "Thuật toán sắp xếp",
	...
	private void openSearchingAlgorithms() {
		...
		String choice = (String) JOptionPane.showInputDialog(this, "Chọn thuật toán tìm kiếm:", "Thuật toán tìm kiếm",
				JOptionPane.QUESTION_MESSAGE, null, searchingOptions, searchingOptions[0]);
